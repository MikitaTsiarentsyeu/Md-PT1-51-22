...
def about(request):
    ...
    return render(request, 'car/about.html', {'page_obj': page_obj, 'menu': menu, 'title': 'В данном блоге могут'
    ' обсуждаться только автомобили VW, хейтеров просим не беспокоиться )))'})
