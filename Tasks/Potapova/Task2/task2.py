...
m_numb_dict = {1: ['одна', 'одной'], 2: ['две', 'двух'],
               3: ['три', 'трёх'], 4: ['четыре', 'четырёх'],
               ...
               21: ['двадцать одна', 'двадцати одной'], 22: ['двадцать две', 'двадцати двух'],
               23: ['двадцать три', 'двадцати трёх'], 24: ['двадцать четыре', 'двадцати четырёх'],
               25: ['двадцать пять', 'двадцати пяти'], 26: ['двадцать шесть', 'двадцати шести'],
               27: ['двадцать семь', 'двадцати семи'], 28: ['двадцать восемь', 'двадцати восьми'],
               29: ['двадцать девять', 'двадцати девяти'], 30: ['тридцать'],
               31: ['тридцать одна'], 32: ['тридцать две'],
               33: ['тридцать три'], 34: ['тридцать четыре'],
               35: ['тридцать пять'], 36: ['тридцать шесть'],
               37: ['тридцать семь'], 38: ['тридцать восемь'],
               39: ['тридцать девять'], 40: ['сорок'],
...
if 10 < minutes < 20:                           # get forms of minute word to final expressions
...
if minutes == 0:
    ...
    answer = f'без {m_numb_dict[60 - minutes][1]} ' \
             f'{minutes_list[1] if (60 - minutes) % 10 == 1 else minutes_list[2]} ' \
